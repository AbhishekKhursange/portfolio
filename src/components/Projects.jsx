...
const PROJECTS = [
  {
    ...
    desc: 'A full-stack food ordering platform where users can add items to cart, and place orders. Built with a React frontend, Express REST API backend, and MongoDB for data storage.',
    category: 'Full Stack',
    status: 'Completed',
    color: '#f59e0b',
    icon: 'bi-bag-heart-fill',
    tech: ['React JS', 'Express JS', 'MongoDB', 'Node.js', 'REST API'],
    highlights: ['User auth & cart', 'Order management', 'Restaurant listings'],
    github: 'https://github.com/AbhishekKhursange/food-delivery-system',
    live: 'https://frontend-ten-eta-10.vercel.app',
  },
  {
    title: 'Product Management System',
    desc: 'A CRUD-based product management dashboard with a React frontend consuming a custom REST API. Supports creating, viewing, updating, and deleting products with category filters.',
    category: 'Full Stack',
    status: 'Completed',
    color: '#4F46E5',
    icon: 'bi-box-seam-fill',
    tech: ['React JS', 'REST API', 'Java', 'Spring Boot'],
    highlights: ['Full CRUD operations', 'REST API integration', 'Responsive UI'],
